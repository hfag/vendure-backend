...
exports.v0161608057253847 = void 0;
class v0161608057253847 {
    async up(queryRunner) {
        ...
        await queryRunner.query("ALTER TABLE `session` ADD `activeChannelId` int NULL", undefined);
        ...
        await queryRunner.query("INSERT INTO `customer_channels_channel` (customerId, channelId) SELECT id, 1 FROM `customer`", undefined);
...
exports.v0161608057253847 = v0161608057253847;
