...
exports.v0171608121093166 = void 0;
class v0171608121093166 {
    async up(queryRunner) {
        ...
        await queryRunner.query("ALTER TABLE `stock_movement` ADD CONSTRAINT `FK_cbb0990e398bf7713aebdd38482` FOREIGN KEY (`orderItemId`) REFERENCES `order_item` (`id`);", undefined);
        ...
        await queryRunner.query("ALTER TABLE `fulfillment` CHANGE `state` `state` varchar(255) NOT NULL", undefined);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query("ALTER TABLE `fulfillment` CHANGE `state` `state` varchar(255) NOT NULL DEFAULT 'Delivered'", undefined);
        await queryRunner.query("ALTER TABLE `product_variant` DROP COLUMN `trackInventory`", undefined);
...
exports.v0171608121093166 = v0171608121093166;
