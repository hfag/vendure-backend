...
exports.v0181610204170263 = void 0;
const migration_utils_v018_1 = require("../migration-utils-v018");
class v0181610204170263 {
    async up(queryRunner) {
        ...
        /* add this line */
        await queryRunner.query("INSERT INTO `order_item_fulfillments_fulfillment` (`orderItemId`, `fulfillmentId`) SELECT `id`, `fulfillmentId` FROM `order_item` WHERE `fulfillmentId` IS NOT NULL", undefined);
        await queryRunner.query("ALTER TABLE `order_item` DROP COLUMN `fulfillmentId`", undefined);
        // Implement FulfillmentHandlers
        /* add DEFAULT value */
        await queryRunner.query("ALTER TABLE `fulfillment` ADD `handlerCode` varchar(255) NOT NULL DEFAULT 'manual-fulfillment'", undefined);
        /* add DEFAULT value */
        await queryRunner.query("ALTER TABLE `shipping_method` ADD `fulfillmentHandlerCode` varchar(255) NOT NULL DEFAULT 'manual-fulfillment'", undefined);
        ...
        /* add this line */
        await queryRunner.query("UPDATE `order_item` SET `adjustments` = `pendingAdjustments`", undefined);
        await queryRunner.query("ALTER TABLE `order_item` ADD `taxLines` text NOT NULL", undefined);
        /* add this line */
        await migration_utils_v018_1.migrateOrderItemPromotionsAndTaxes(queryRunner);
        ...
        /* add this line */
        await queryRunner.query("UPDATE `order_item` SET `listPrice` = `unitPrice`", undefined);
        /* add this line */
        await queryRunner.query("UPDATE `order_item` SET `listPriceIncludesTax` = false", undefined);
        ...
        /* add this line */
        await queryRunner.query("UPDATE `order` SET `subTotalWithTax` = `subTotal`", undefined);
        /* add this line */
        await queryRunner.query("UPDATE `order` SET `subTotal` = `subTotalBeforeTax`", undefined);
        ...
        /* add this line */
        await migration_utils_v018_1.migrateOrderAdjustmentsToSurcharges(queryRunner);
        ...
        /* add this line */
        await migration_utils_v018_1.migrateDefaultShippingCalculatorArgs(queryRunner);
        ...
        await migration_utils_v018_1.migrateOrderShippingToShippingLines(queryRunner);
        ...
        /* add this line */
        await migration_utils_v018_1.addProductVariantsToProductChannels(queryRunner);
    ...
    async down(queryRunner) {
        await queryRunner.query("ALTER TABLE `order_modification_order_items_order_item` DROP FOREIGN KEY `FK_9d631d7bd3d44af50eca535d728`", undefined);
        await queryRunner.query("ALTER TABLE `order_modification_order_items_order_item` DROP FOREIGN KEY `FK_a48502a38aded69d087a8ec08ad`", undefined);
        await queryRunner.query("ALTER TABLE `order_item_fulfillments_fulfillment` DROP FOREIGN KEY `FK_8132041a647c28eb27ecc1691fa`", undefined);
        await queryRunner.query("ALTER TABLE `order_item_fulfillments_fulfillment` DROP FOREIGN KEY `FK_a568a3d5aa7f237edab624960b9`", undefined);
        ...
        await queryRunner.query("ALTER TABLE `order` DROP COLUMN `subTotalWithTax`", undefined);
        await queryRunner.query("ALTER TABLE `shipping_method` DROP COLUMN `fulfillmentHandlerCode`", undefined);
        await queryRunner.query("ALTER TABLE `order_item` DROP COLUMN `taxLines`", undefined);
        await queryRunner.query("ALTER TABLE `order_item` DROP COLUMN `adjustments`", undefined);
        await queryRunner.query("ALTER TABLE `order_item` DROP COLUMN `listPriceIncludesTax`", undefined);
        await queryRunner.query("ALTER TABLE `order_item` DROP COLUMN `listPrice`", undefined);
        await queryRunner.query("ALTER TABLE `fulfillment` DROP COLUMN `handlerCode`", undefined);
        await queryRunner.query("ALTER TABLE `order` ADD `shippingMethodId` int NULL", undefined);
        await queryRunner.query("ALTER TABLE `order` ADD `subTotalBeforeTax` int NOT NULL", undefined);
        await queryRunner.query("ALTER TABLE `order` ADD `pendingAdjustments` text NOT NULL", undefined);
        await queryRunner.query("ALTER TABLE `order_item` ADD `fulfillmentId` int NULL", undefined);
        await queryRunner.query("ALTER TABLE `order_item` ADD `pendingAdjustments` text NOT NULL", undefined);
        await queryRunner.query("ALTER TABLE `order_item` ADD `taxRate` decimal(5,2) NOT NULL", undefined);
        await queryRunner.query("ALTER TABLE `order_item` ADD `unitPrice` int NOT NULL", undefined);
        await queryRunner.query("ALTER TABLE `product_variant` ADD `lastPriceValue` int NOT NULL COMMENT 'Not used - actual price is stored in product_variant_price table'", undefined);
        await queryRunner.query("DROP INDEX `IDX_9d631d7bd3d44af50eca535d72` ON `order_modification_order_items_order_item`", undefined);
        await queryRunner.query("DROP INDEX `IDX_a48502a38aded69d087a8ec08a` ON `order_modification_order_items_order_item`", undefined);
        await queryRunner.query("DROP TABLE `order_modification_order_items_order_item`", undefined);
        await queryRunner.query("DROP INDEX `IDX_8132041a647c28eb27ecc1691f` ON `order_item_fulfillments_fulfillment`", undefined);
        await queryRunner.query("DROP INDEX `IDX_a568a3d5aa7f237edab624960b` ON `order_item_fulfillments_fulfillment`", undefined);
        ...
        await queryRunner.query("CREATE UNIQUE INDEX `IDX_42187bb72520a713d625389489` ON `product_translation` (`languageCode`, `slug`)", undefined);
        await queryRunner.query("ALTER TABLE `order` ADD CONSTRAINT `FK_4af424d3e7b2c3cb26e075e20fc` FOREIGN KEY (`shippingMethodId`, `shippingMethodId`) REFERENCES `shipping_method`(`id`,`id`) ON DELETE NO ACTION ON UPDATE NO ACTION", undefined);
        await queryRunner.query("ALTER TABLE `order_item` ADD CONSTRAINT `FK_eed51be48640c21e1c76d3e9fbe` FOREIGN KEY (`fulfillmentId`, `fulfillmentId`) REFERENCES `fulfillment`(`id`,`id`) ON DELETE NO ACTION ON UPDATE NO ACTION", undefined);
    }
}
exports.v0181610204170263 = v0181610204170263;
